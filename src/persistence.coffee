...
modifySDK = (sdk) ->
  ...
  wrapSave sdk, 'saveMember', (member) ->
    promises.when(
      ...
      sdk.loadContacts memberId: member.id
      sdk.loadContactEmailAddresses memberId: member.id
      sdk.loadContactPhoneNumbers memberId: member.id
    )
  ...
  wrapMethod sdk, 'inviteContactEmailAddresses',
    (inviteContactEmailAddresses) ->
      (params, callback) ->
