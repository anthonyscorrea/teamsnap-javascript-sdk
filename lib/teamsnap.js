...
require.register("collections/advertisements.coffee", function(exports, require, module) {
...
require.register("collections/batchInvoiceLineItems.coffee", function(exports, require, module) {
...
require.register("collections/batchInvoices.coffee", function(exports, require, module) {
...
require.register("collections/divisionAggregates.coffee", function(exports, require, module) {
...
require.register("collections/divisionStores.coffee", function(exports, require, module) {
...
require.register("collections/eventLineupEntries.coffee", function(exports, require, module) {
exports.createEventLineupEntry = function(data) {
  return this.createItem(data, {
    type: 'eventLineupEntry'
  });
};

exports.saveEventLineupEntry = function(eventLineupEntry, callback) {
  if (!eventLineupEntry) {
    throw new TSArgsError('teamsnap.saveEventLineupEntry', "`eventLineupEntry` must be provided");
  }
  if (!this.isItem(eventLineupEntry, 'eventLineupEntry')) {
    throw new TSArgsError('teamsnap.saveEventLineupEntry', "`type` must be 'eventLineupEntry'");
  }
  if (!eventLineupEntry.eventLineupId) {
    return this.reject('You must choose a eventLineup', 'eventLineup', callback);
  }
  if (!eventLineupEntry.memberId) {
    return this.reject('You must choose a member', 'member', callback);
  }
  return this.saveItem(eventLineupEntry, callback);
};

exports.deleteEventLineupEntry = function(eventLineupEntry, callback) {
  if (!eventLineupEntry) {
    throw new TSArgsError('teamsnap.saveEventLineupEntry', "`eventLineupEntry` must be provided");
  }
  return this.deleteItem(eventLineupEntry, callback);
};

});

require.register("collections/eventLineups.coffee", function(exports, require, module) {
exports.loadEventLineups = function(params, callback) {
  if (this.isId(params)) {
    params = {
      eventId: params
    };
  } else if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadEventLineups', 'must provide a eventId or query parameters');
  }
  return this.loadItems('eventLineup', params, callback);
};

exports.createEventLineup = function(data) {
  return this.createItem(data, {
    type: 'eventLineup',
    isPublished: false
  });
...
exports.saveEventLineup = function(eventLineup, callback) {
  if (!eventLineup) {
    throw new TSArgsError('teamsnap.saveEventLineup', "`eventLineup` must be provided");
  }
  if (!eventLineup.eventId) {
    return this.reject('You must choose a event.', 'eventId', callback);
  }
  return this.saveItem(eventLineup, callback);
};

exports.deleteEventLineup = function(eventLineup, callback) {
  if (!eventLineup) {
    throw new TSArgsError('teamsnap.deleteEventLineup', "`eventLineup` must be provided");
  }
  return this.deleteItem(eventLineup, callback);
};
...
require.register("collections/forecasts.coffee", function(exports, require, module) {
...
require.register("collections/invoiceLineItems.coffee", function(exports, require, module) {
...
require.register("collections/invoiceTransactions.coffee", function(exports, require, module) {
...
require.register("collections/invoices.coffee", function(exports, require, module) {
...
require.register("collections/partnerUserPreferences.coffee", function(exports, require, module) {
...
require.register("collections/partnersPreferences.coffee", function(exports, require, module) {
...
require.register("collections/registrationFormLineItemOptions.coffee", function(exports, require, module) {
...
require.register("collections/registrationFormLineItems.coffee", function(exports, require, module) {
...
require.register("collections/teamNames.coffee", function(exports, require, module) {
...
require.register("collections/teamStores.coffee", function(exports, require, module) {
...
exports.dspPayload = function(params, callback) {
  if (this.isId(params)) {
    params = {
      memberId: params
    };
  ...
  return this.collections.users.queryItems('dspPayload', params, callback);
};
...
require.register("eventEmitter.coffee", function(exports, require, module) {
...
add(require('./collections/eventLineups'));

add(require('./collections/eventLineupEntries'));
...
require.register("stringent.coffee", function(exports, require, module) {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.62.1';
  ...
  TeamSnap.prototype.useEventEmitter = false;
